...
class CAssembler {
	public:
		...
		// }
                ...
                bool exportVHDL( string templateFileName, string outputFileName, string entityName, bool bVHDL ) ;
                bool exportMEM( string outputFile, string outputDir);

                bool exportHex(string outputFileName) ;
	...
	protected:
		...
		bool addInstruction( instrNumber instr, CSourceLine sourceLine, int offset ) ;
                ...
                bool convertTokenToUnsignedValue(string str, unsigned int &value);
