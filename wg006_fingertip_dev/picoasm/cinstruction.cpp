...
void CInstruction::Print(std::ostream &os)
{
...
void ADD_SX_KK::Print(std::ostream &os)
{
	os << "ADD " << "s" << sX << "," << kk ;
}
...
void ADD_SX_SY::Print(std::ostream &os)
{
	os << "ADD " << "s" << sX << "," << "s" << sY ;
}
...
void ADDCY_SX_KK::Print(std::ostream &os)
{
	os << "ADDCY " << "s" << sX << "," << sY ;
}
...
void ADDCY_SX_SY::Print(std::ostream &os)
{
	os << "ADDCY " << "s" << sX << "," << "s" << sY ;
}
...
void AND_SX_KK::Print(std::ostream &os)
{
	os << "AND " << "s" << sX << "," << sY ;
}
...
void AND_SX_SY::Print(std::ostream &os)
{
	os << "AND " << "s" << sX << "," << "s" << sY ;
}
...
void CALLC::Print(std::ostream &os)
{
	os << "CALL C " << address ;
}
...
void CALLNC::Print(std::ostream &os)
{
	os << "CALL NC " << address ;
}
...
void CALLNZ::Print(std::ostream &os)
{
	os << "CALL NZ " << address ;
}
...
void CALLZ::Print(std::ostream &os)
{
	os << "CALL Z " << address ;
}
...
void COMPARE_SX_KK::Print(std::ostream &os)
{
	os << "COMPARE s" << sX << ", "  << kk ;
}
...
void COMPARE_SX_SY::Print(std::ostream &os)
{
	os << "COMPARE s" << sX << ", s" << kk ;
}
...
void DISABLE_INTERRUPT::Print(std::ostream &os)
{
	os << "DISABLE INTERRUPT" ;
}
...
void ENABLE_INTERRUPT::Print(std::ostream &os)
{
	os << "ENABLE INTERRUPT" ;
}
...
void FETCH_SX_SS::Print(std::ostream &os)
{
	os << "FETCH " << "s" << sX << ", " << ss ;
}
...
void FETCH_SX_SY::Print(std::ostream &os) {
	os << "FETCH " << "s" << sX << ", " << "s" << sY ;
}
...
void INPUT_SX_SY::Print(std::ostream &os)
{
	os << "INPUT " << "s" << sX << ", " << "s" << sY ;
}
...
void INPUT_SX_PP::Print(std::ostream &os)
{
	os << "INPUT " << "s" << sX << ", " << pp ;
}
...
void JUMP::Print(std::ostream &os)
{
	os << "JUMP " << address ;
}
...
void JUMPC::Print(std::ostream &os)
{
	os << "JUMP C " << address ;
}
...
void JUMPNC::Print(std::ostream &os)
{
	os << "JUMP NC " << address ;
}
...
void JUMPNZ::Print(std::ostream &os)
{
	os << "JUMP NZ " << address ;
}
...
void JUMPZ::Print(std::ostream &os)
{
	os << "JUMP Z " << address ;
}
...
void LOAD_SX_KK::Print(std::ostream &os)
{
	os << "LOAD " << "s" << sX << ", " << kk ;
}
...
void LOAD_SX_SY::Print(std::ostream &os)
{
	os << "LOAD " << "s" << sX << ", " << "s" << sY ;
}
...
void OR_SX_KK::Print(std::ostream &os)
{
	os << "OR " << "s" << sX << ", " << kk ;
}
...
void OR_SX_SY::Print(std::ostream &os)
{
	os << "OR " << "s" << sX << ", " << "s" << sY ;
}
...
void OUTPUT_SX_SY::Print(std::ostream &os)
{
	os << "OUTPUT " << "s" << sX << ", " << "s" << sY ;
}
...
void OUTPUT_SX_PP::Print(std::ostream &os)
{
	os << "OUTPUT " << "s" << sX << ", " << pp ;
}
...
void RETURNC::Print(std::ostream &os)
{
	os << "RETURN C" ;
}
...
void RETURNNC::Print(std::ostream &os)
{
	os << "RETURN NC" ;
}
...
void RETURNNZ::Print(std::ostream &os)
{
	os << "RETURN NZ" ;
}
...
void RETURNZ::Print(std::ostream &os)
{
	os << "RETURN Z" ;
}
...
void RETURNI_DISABLE::Print(std::ostream &os)
{
	os << "RETURNI DISABLE" ;
}
...
void RETURNI_ENABLE::Print(std::ostream &os)
{
	os << "RETURNI ENABLE" ;
}
...
void RL_SX::Print(std::ostream &os)
{
	os << "RL s" << sX ;
}
...
void RR_SX::Print(std::ostream &os)
{
	os << "RR s" << sX ;
}
...
void SL0_SX::Print(std::ostream &os)
{
	os << "SL0 s" << sX ;
}
...
void SL1_SX::Print(std::ostream &os)
{
	os << "SL1 s" << sX ;
}
...
void SLA_SX::Print(std::ostream &os)
{
	os << "SLA s" << sX ;
}
...
void SLX_SX::Print(std::ostream &os)
{
	os << "SLX s" << sX ;
}
...
void SR0_SX::Print(std::ostream &os)
{
	os << "SR0 s" << sX ;
}
...
void SR1_SX::Print(std::ostream &os)
{
	os << "SR1 s" << sX ;
}
...
void SRA_SX::Print(std::ostream &os)
{
	os << "SRA s" << sX ;
}
...
void SRX_SX::Print(std::ostream &os)
{
	os << "SRX s" << sX ;
}
...
void STORE_SX_SS::Print(std::ostream &os)
{
	os << "STORE s" << sX << ", " << ss ;
}
...
void STORE_SX_SY::Print(std::ostream &os)
{
	os << "STORE s" << sX << ", s" << sY ;
}
...
void SUB_SX_KK::Print(std::ostream &os)
{
	os << "SUB s" << sX << ", " << kk ;
}
...
void SUB_SX_SY::Print(std::ostream &os)
{
	os << "SUB s" << sX << ", s" << sY ;
}
...
void SUBCY_SX_KK::Print(std::ostream &os)
{
	os << "SUBCY s" << sX << ", " << kk ;
}
...
void SUBCY_SX_SY::Print(std::ostream &os)
{
	os << "SUBCY s" << sX << ", s" << sY ;
}
...
void TEST_SX_KK::Print(std::ostream &os)
{
	os << "TEST s" << sX << ", " << kk ;
}
...
void TEST_SX_SY::Print(std::ostream &os)
{
	os << "TEST s" << sX << ", s" << sY ;
}
...
void XOR_SX_KK::Print(std::ostream &os)
{
	os << "XOR s" << sX << ", " << kk ;
}
...
void XOR_SX_SY::Print(std::ostream &os)
{
	os << "XOR s" << sX << ", s" << sY ;
}
...
void RESET_EVENT::Print(std::ostream &os)
{
	os << "(RESET EVENT)" ;
}
...
void INTERRUPT_EVENT::Print(std::ostream &os)
{
	os << "(INTERRUPT EVENT)" ;
}
